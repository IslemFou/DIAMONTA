...
<footer class="d-flex flex-column justify-content-center align-items-center text-white">
  ...
  <!-- <img src="<?= BASE_URL; ?>assets/media/img/footer-diamonds.png" alt="diamonds" class="img-fluid w-100"
    style="z-index: -1;" id="footer_background"> -->
</footer>
